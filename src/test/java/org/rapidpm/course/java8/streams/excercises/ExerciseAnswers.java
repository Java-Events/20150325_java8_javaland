package org.rapidpm.course.java8.streams.excercises;
 ...
 * and remove the   tag. Then run the tests using Alt-F6.
 */
...
//        reader = Files.newBufferedReader(Paths.get("SonnetI.txt"), StandardCharsets.UTF_8);
        reader = new BufferedReader(new StringReader("From fairest creatures we desire increase,\n" +
                "That thereby beauty's rose might never die,\n" +
                "But as the riper should by time decease,\n" +
                "His tender heir might bear his memory:\n" +
